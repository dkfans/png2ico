...
release: clean png2ico doc/png2ico.txt
	...
	tar czf png2ico/png2ico-src-$${version}.tar.gz png2ico/{LICENSE,VERSION,Makefile,README,README.unix,README.win,doc/bmp.txt,doc/png2ico.1,makefile.bcc32,makezlib.bcc32,png2ico.cpp} && \
